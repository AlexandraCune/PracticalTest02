...
public class ServerThread extends Thread{
    ...
    public synchronized void setData(String key, DataObject dataResponse) {
        this.data.put(key, dataResponse);
    }

    public synchronized HashMap<String, DataObject> getData() {
        return data;
    }
